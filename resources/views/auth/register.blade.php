            ...
            <div class="row w-100 justify-content-center g-0 shadow-sm my-2">
                <div class="col-md-6 bg-aabu order-1">
                    <div class="p-3 d-flex flex-column h-100 justify-content-between">
                        ...
                        <div class="text-center">
                            <a href="{{ getLocaleURL('/login') }}" class="btn btn-light px-3 rounded-0">{{ __('auth.login_instead') }}</a>
                            <a href="{{ getLocaleURL('/') }}" class="btn btn-outline-light px-3 rounded-0">{{ __('auth.continue_guest') }}</a>
                        </div>
                    </div>
                </div>
